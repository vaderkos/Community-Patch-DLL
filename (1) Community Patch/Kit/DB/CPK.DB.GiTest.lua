...
CPK.DB.GiTest = function()
	...
	print('Memory Consumption for ' .. #tbl_names .. ' tables', MeasureGiMemoryMB(tbl_names))
	...
	PrintBenchmark(function()
		...
		_ = p.GridX
		_ = p.GridY
	end, "GameInfo Properties Access")
	...
	PrintBenchmark(function()
		...
		_ = p.GridX
		_ = p.GridY
	end, "Gi Properties Access")

	PrintBenchmark(function()
		local _, _, _, _, _, _, _ = Gi.Policies.POLICY_LIBERTY(
			'Description',
			'ID',
